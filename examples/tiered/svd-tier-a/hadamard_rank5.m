...
%
% Question: A tiny fifth singular value next to a null space.
% Steps:
...
% Matching documentation: docs/examples/tiered/svd-tier-a/hadamard_rank5.md
...
assert (result.scope_ok && strcmp (result.status, "PASS") ...
        && result.case_count == 1);
fprintf ("A5-RANK5: PASS; selected cases=%d; measured rows=%d\n", ...
         result.case_count, result.measured_svd_rows);
fprintf ("See docs/examples/tiered/svd-tier-a/hadamard_rank5.md for interpretation.\n");
