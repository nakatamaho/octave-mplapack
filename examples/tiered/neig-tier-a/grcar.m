...
%
% Question: A dense-output nonsymmetric Grcar band matrix.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-a/grcar.md
...
fprintf ("GRCAR: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-a/grcar.md for interpretation.\n");
