...
%
% Question: A two-sided Hadamard mixing of a geometrically decaying spectrum.
% Steps:
...
% Matching documentation: docs/examples/tiered/svd-tier-a/hadamard_geometric.md
...
assert (result.scope_ok && strcmp (result.status, "PASS") ...
        && result.case_count == 1);
fprintf ("A5-GEO: PASS; selected cases=%d; measured rows=%d\n", ...
         result.case_count, result.measured_svd_rows);
fprintf ("See docs/examples/tiered/svd-tier-a/hadamard_geometric.md for interpretation.\n");
