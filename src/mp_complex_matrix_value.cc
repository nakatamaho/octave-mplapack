...
bool octave_mplapack_mpc_matrix_internal::is_storable () const { return true; }
...
bool
octave_mplapack_mpc_matrix_internal::save_ascii (std::ostream& os)
{
  return octave_mplapack::save_native_mpc_matrix (os, m_storage);
}

bool
octave_mplapack_mpc_matrix_internal::load_ascii (std::istream& is)
{
  return octave_mplapack::load_native_mpc_matrix (is, m_storage);
}

bool
octave_mplapack_mpc_matrix_internal::save_binary (std::ostream& os, bool)
{
  return octave_mplapack::save_native_mpc_matrix (os, m_storage);
}

bool
octave_mplapack_mpc_matrix_internal::load_binary (
