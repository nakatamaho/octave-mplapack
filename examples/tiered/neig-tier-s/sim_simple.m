% Near-simple similarity.
%
% Question: A diagonalizable pair with a tiny dyadic gap.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-s/sim_simple.md
...
fprintf ("SIM_SIMPLE: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-s/sim_simple.md for interpretation.\n");
