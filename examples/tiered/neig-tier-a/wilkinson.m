...
%
% Question: The recurrence-generated Wilkinson polynomial companion model.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-a/wilkinson.md
...
fprintf ("WILKINSON: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-a/wilkinson.md for interpretation.\n");
