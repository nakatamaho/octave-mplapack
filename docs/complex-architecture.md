...
thread isolation check.  The special-value probe preserves signed zero,
Inf, and NaN component state through an `mpc_class` copy.  The probe uses
MPFR's documented negative-sign argument for negative zero.
