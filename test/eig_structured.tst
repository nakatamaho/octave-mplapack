...
%! unwind_protect
%!   mpbits (256);
%!   assert_rejected (@() eig (mp ([1, 2; 3, 4])), ...
%!                    "nonsymmetric real eig must be rejected in N04");
%!   assert_rejected (@() eig (mp ([1 + 1i, 2; 3, 4])), ...
%!                    "non-Hermitian complex eig must be rejected in N04");
%!   assert_rejected (@() eig (mp ([1 + 1i, 0; 0, 2])), ...
%!                    "complex diagonal imaginary part must be rejected");
