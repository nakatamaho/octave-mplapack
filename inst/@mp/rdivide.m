...
function result = rdivide (lhs, rhs)
  ...
  ## Divide real scalar operands with @code{./}.  Division by zero and
  ## special values follow MPFR round-to-nearest semantics.  Matrix right
  ## division @code{/} remains unsupported.
  ## @end deftypefn
  if (nargin != 2)
