...
%
% Question: The diagonally scaled nonsymmetric tridiagonal Toeplitz model.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-s/toeplitz.md
...
fprintf ("TOEPLITZ: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-s/toeplitz.md for interpretation.\n");
