...
%
% Question: The fixed-precision error-free triple-product generator in real standard form.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-s/oo53_real.md
...
fprintf ("OO53_REAL: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-s/oo53_real.md for interpretation.\n");
