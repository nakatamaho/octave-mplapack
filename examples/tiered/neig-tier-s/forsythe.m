...
%
% Question: The tiny-corner cyclic perturbation of a Jordan block.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-s/forsythe.md
...
fprintf ("FORSYTHE: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-s/forsythe.md for interpretation.\n");
