...
Matrix `char`, assignment, transpose, concatenation, and logical indexing
remain outside M10. M11 builds direct element-wise arithmetic on the same
precision-preserving matrix payload.
