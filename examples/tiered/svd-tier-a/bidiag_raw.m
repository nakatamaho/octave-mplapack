...
%
% Question: A graded bidiagonal matrix with dyadic diagonal and superdiagonal.
% Steps:
...
% Matching documentation: docs/examples/tiered/svd-tier-a/bidiag_raw.md
...
assert (result.scope_ok && strcmp (result.status, "PASS") ...
        && result.case_count == 1);
fprintf ("A3-BDI-RAW: PASS; selected cases=%d; measured rows=%d\n", ...
         result.case_count, result.measured_svd_rows);
fprintf ("See docs/examples/tiered/svd-tier-a/bidiag_raw.md for interpretation.\n");
