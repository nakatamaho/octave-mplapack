...
## -*- texinfo -*-
## @deftypefn {} {@var{result} =} expm1 (@dots{})
...
function result = expm1 (value)
  if (nargin != 1 || ! isa (value, "mp"))
    error ("mplapack:mp:InvalidInput", "expm1 expects one mp value");
  endif
  payload = __mplapack_core__ ("script_elementary", value, "expm1");
