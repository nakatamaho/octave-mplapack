...
%
% Question: A positive stochastic matrix with a controlled spectral scale.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-a/markov.md
...
fprintf ("MARKOV: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-a/markov.md for interpretation.\n");
