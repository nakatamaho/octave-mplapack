...
%
% Question: A defective 2-by-2 Jordan block embedded in a dense similarity.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-s/sim_jordan.md
...
fprintf ("SIM_JORDAN: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-s/sim_jordan.md for interpretation.\n");
