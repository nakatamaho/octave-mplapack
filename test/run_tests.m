...
run (fullfile (test_dir, "test_neigt23.m"));
fprintf ("PASS: NEIGT23 exact output and independent replay tests\n");
run (fullfile (test_dir, "test_neigt24.m"));
fprintf ("PASS: NEIGT24 numbered examples and documentation integration tests\n");
