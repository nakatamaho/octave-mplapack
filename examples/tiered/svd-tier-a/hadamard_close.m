...
%
% Question: A pair of nearly equal positive singular values.
% Steps:
...
% Matching documentation: docs/examples/tiered/svd-tier-a/hadamard_close.md
...
assert (result.scope_ok && strcmp (result.status, "PASS") ...
        && result.case_count == 1);
fprintf ("A5-CLOSE: PASS; selected cases=%d; measured rows=%d\n", ...
         result.case_count, result.measured_svd_rows);
fprintf ("See docs/examples/tiered/svd-tier-a/hadamard_close.md for interpretation.\n");
