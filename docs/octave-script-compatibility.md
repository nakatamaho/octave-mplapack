...
| NEIGT Tier-S/Tier-A and verified V-S/V-A examples | SUPPORTED | `docs/examples/tiered/README.md`, `examples/14_neig_tier_s.m` through `examples/17_neig_verified_va.m`; 120/168 ordinary rows and 26 verification jobs per profile |
