...
three-output forms), LU, `norm`, transpose, reshape, and concatenation.
...
`cond`, `eig`, `svd`, power, unimplemented transcendental, or update
...
firewall checks representative `eig`, `svd`, `det`, `inv`, `rank`,
