% Tall Lauchli matrix.
%
% Question: A tall rank-sensitive Lauchli matrix.
% Steps:
...
% Matching documentation: docs/examples/tiered/svd-tier-a/lauchli_tall.md
...
assert (result.scope_ok && strcmp (result.status, "PASS") ...
        && result.case_count == 1);
fprintf ("A4-LAU-TALL: PASS; selected cases=%d; measured rows=%d\n", ...
         result.case_count, result.measured_svd_rows);
fprintf ("See docs/examples/tiered/svd-tier-a/lauchli_tall.md for interpretation.\n");
