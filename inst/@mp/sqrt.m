...
## -*- texinfo -*-
## @deftypefn {} {@var{result} =} sqrt (@dots{})
...
function result = sqrt (value)
  if (nargin != 1 || ! isa (value, "mp"))
    error ("mplapack:mp:InvalidInput", "sqrt expects one mp value");
  endif
  payload = __mplapack_core__ ("script_elementary", value, "sqrt");
