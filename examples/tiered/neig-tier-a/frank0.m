...
%
% Question: The standard upper-Hessenberg Frank matrix.
% Steps:
...
% Matching documentation: docs/examples/tiered/neig-tier-a/frank0.md
...
fprintf ("FRANK0: PASS; selected cases=%d; measured rows=%d\n", ...
         result.coverage.case_count, result.coverage.measured_eig_rows);
fprintf ("See docs/examples/tiered/neig-tier-a/frank0.md for interpretation.\n");
